...
<html lang="en">
	...
	<body>
        ...
        <?php
            ...
            $host="localhost";  
            $duser="root";  
            $dpaswd="";   // leave empty for XAMPP default  
            $dname="aqi_db";  // the DB you created in phpMyAdmin  
            ...
            {
                $qry="SELECT * FROM ap ORDER BY id DESC LIMIT 1;";
                        ...
                        if($result=mysqli_query($db,$qry))
                        {
                            ...
                            $co    = $data['CO'];
                            $no2   = $data['NO2'];
                            $o3    = $data['O3'];           // updated from 'OZONE' to 'O3'
                            $nh3   = $data['NH3'];
                            $so2   = $data['SO2'];
                            $temp  = $data['TEMPERATURE'];  // updated to uppercase
                            $alt   = $data['ALTITUDE'];     // updated to uppercase
                            $humid = $data['HUMIDITY'];     // updated to uppercase
                            $AQI   = $data['AQI'];          // stays the same
